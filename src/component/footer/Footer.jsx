        ...
        <footer className="footer bg-[#344D3F] text-white py-5">
         <div className="w-full my-5">
            <div className="flex flex-col justify-center items-center gap-7  w-11/12 mx-auto my-7">
                <h1 className='font-bold text-[50px] text-center'>KeenKeeper</h1>
            ...
            <div className="flex flex-row justify-between items-center mx-auto w-10/12 border-t border-[#6b8a75] pt-5 ">
